...
// Recipe objects with name, ingredients, instructions, and category (Tag)
const recipe = [
  {
    name: 'Pork Adobo',
    Ingredients: [
  ...
  },
  {
    ...
    Instructions: [
      ...
      'Transfer to a serving bowl. Serve with a spicy fish sauce dipping sauce. Share and enjoy!'
    ],
    Tagy: 'Lunch'
  },
  {
    ...
    Instructions: [
      ...
      'When the onions and tomatoes become soft, add the chicken and then cook until the color of the outer part turns light brown.',
      'Pour-in the fish sauce, and then add chicken bouillon. Stir. Pour-in water and let boil.',
  ...
  },
  {
    ...
    Ingredients: [
      ...
      'Optional: 2 bunches Bok-choi, sliced'
    ],
    Instructions: [
      'Heat up a pan over medium heat. Add 1 tablespoon of oil and sauté onion and garlic until fragrant.',
      'Add the remaining oil and let it heat up before adding the pork kasim and pork liempo.',
      'Fry until lightly browned and then add the pork liver. Cook for about 2 minutes.',
      'Add the Knorr Pork Cubes into the pot and stir well until completely dissolved. Then add the tomato sauce, water, sugar, and black pepper. Mix well.',
      'Add the carrots and potatoes into the pan. Cook over low heat until the meat and vegetables are cooked through and the sauce has thickened.',
      'Add raisins, bell pepper, and bok choy, if using. Let the pork menudo cook for 2 more minutes. Take off the heat and prepare to serve.'
    ],
    Tag: 'Dinner'
  },
  {
    name: 'Grilled Pork',
    Ingredients: [
      '500 g pork cutlets, skin and fat trimmed',
      '5 tbsp Knorr Liquid Seasoning',
      'Ground black pepper'
    ],
    Instructions: [
      'Combine Knorr Liquid Seasoning and ground pepper in a small sealable bag or a bowl and place the pork cutlet to marinate. Keep in the marination for at least 20 minutes to get full flavor and taste.',
      'Remove the pork cutlets from the marination, and place on a grill. Grill for 3-5 minutes per side, depending on the thickness of the cuts. Brush on the marination if the cuts become dry while grilling.',
      'Serve hot and Enjoy!'
    ],
    Tag: 'Dinner'
  },
  {
    ...
    Instructions: [
      'Another reason why you should make this dish often is because it’s so easy and delicious. You just need to combine all the ingredients in a pot and bring it all to a boil.',
      'Reduce the heat to a simmer and cook until the pork is fork-tender and the sauce is nice and thick.',
      'Next, you just need to taste the seasoning and adjust if necessary.',
      'Something as delicious as this is best enjoyed with the company of family and friends, so bring this dish to your next gathering and everybody will surely ask for the recipe.'
    ],
    Tag: 'Dinner'
  },
  {
  ...
  },
  {
    ...
    Ingredients: [
      ...
      '1 pack pechay Tagalog, sliced or Bok-Choy',
      'Other vegetables to include: Pumpkin flowers, spinach'
    ],
    Instructions: [
      'First, you need to tenderize the oxtail to be able to enjoy this majestic dish. Get a pot and throw the oxtail and quartered onions in. Pour the water, boil over high heat, and then reduce to a simmer until the oxtail is tender. Make sure that the meat is submerged to allow even cooking. Once tender, strain the oxtail from the broth and set aside the meat and broth.',
      'Now, get a pan and combine the oil and annatto seeds. Cook over low heat for 3 minutes or until the color of the oil turns orange. Strain out the seeds, then pour the infused oil back into the pan. Throw in the onions and garlic and sauté until lightly toasted. Add the softened oxtail next and continue to sauté.',
      'Just a few more steps, and this dish is done. Add your favorite peanut butter brand, 1-1/2 cups of broth (where oxtail was softened), and Knorr Beef Cubes. Mix well until peanut butter is dissolved. Simmer for 15-20 minutes until the sauce has slightly thickened.',
      'Add the vegetables last and cook until done. Thats it! Classic Kare-Kare is best enjoyed with a serving of warm bagoong. We kid you not, and you will definitely eat more than usual. So, prepare a large pot of rice nearby for those extra servings.',
  ...
  },
  {
    ...
    Ingredients: [
      ...
      '1 pc ginger, grated',
      '2 stalks lemongrass (tanglad), pounded and sliced',
      '4 tbsp brown sugar',
      '1/4 cup annatto (achuete) oil',
      '1 pc Knorr Chicken Cube, mashed'
    ],
    Instructions: [
      'It is true that the simplest of dishes are the most delicious. For example, we have this Chicken Inasal recipe which can be made with only 2 steps. Place the chicken pieces in a food-grade plastic container along with the cane vinegar, garlic, ginger, lemongrass, sugar, anatto oil, and Knorr Chicken Cube. Mix this well and leave in the chiller to develop the flavors overnight.',
      'This Inasal recipe is not only easy to make but it is also flexible. You have the option of grilling this over hot coal or pan-frying it over the stovetop while basting it in its own sauce.',
...
// Endpoint to get a specific recipe by name
...
const validateRecipe = [
  ...
  body('Tag').notEmpty().withMessage('Procedure is required'),
];
...
app.put('/api/recipes/:name', (req, res) => {
  ...
  recipeToUpdate.Tag = req.body.instructions;
...
// Set up the Express.js app to listen on a specified port
